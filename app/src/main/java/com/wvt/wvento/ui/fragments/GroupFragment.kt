...
class GroupFragment : Fragment() {
    ...
    private fun showLocationDialog() {
        val singleItems = arrayOf(
            "Andhra Pradesh", "Bihar", "Chhattisgarh", "Haryana", "Himachal Pradesh", "Jharkhand", "Karnataka",
            "Madhya Pradesh", "Maharashtra", "Meghalaya", "Rajasthan", "Tamil Nadu", "Telangana", "Uttar Pradesh", "Uttarakhand"
        )
        var checkedItem = 0
